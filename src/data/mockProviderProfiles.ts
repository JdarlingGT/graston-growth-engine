...
// Free Tier Profiles (30)
export const freeProfiles: ProviderProfile[] = [
  {
    id: 'free-001',
  ...
  // ... (28 more free profiles)
];

// Preferred Tier Profiles (30)
export const preferredProfiles: ProviderProfile[] = [
  {
    id: 'pref-001',
  ...
  // ... (29 more preferred profiles)
];

// Premier Tier Profiles (30)
export const premierProfiles: ProviderProfile[] = [
  {
    id: 'prem-001',
  ...
  // ... (29 more premier profiles)
];

export const allProfiles = [...freeProfiles, ...preferredProfiles, ...premierProfiles];